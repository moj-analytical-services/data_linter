...
## 4.1.2 - 2021-01-27
- If there were some failures and `all_must_pass` is true, the passed tables won't be copied over any more

## 4.1.1 - 2020-12-16

- Fix incorrect error message (#115)
- Improved handling of keep_default_na=False (#116)
## 4.1.0 - 2020-11-24
